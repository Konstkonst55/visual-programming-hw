...
# Домашнее задание №11. Подключение базы данных к веб-приложению
...
3. Заменить репозиторий (удалять сам класс не нужно), который хранил данные в памяти, реализованый в предыдущем домашнем задании, на реализованый в п.2, чтобы веб-приложение в качестве хранилища использовало БД. По умолчанию после установки в `PostgreSQL` существует пользователь postgres с паролем postgres.

Материалы для изучения:

- По взаимодействию с БД: [`https://metanit.com/sharp/efcore/`](https://metanit.com/sharp/efcore/)
- `ASP.NET Core`: [`https://metanit.com/sharp/aspnet6/`](https://metanit.com/sharp/aspnet6/)

# Домашнее задание №12. Логгирование
...
Для решения предыдущего домашнего задания создайте таблицу в базе данных для хранения логов.

Реализуйте провайдер логгирования в базу данных и добавьте запись логов при выполнении обработчиков конечных точек.

Реализуйте приложение на React для просмотра логов с поиском и фильтрацией. 